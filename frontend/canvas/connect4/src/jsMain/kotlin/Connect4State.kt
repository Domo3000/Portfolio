...
class WebsocketState(private val path: String, private val socketHost: String, private val socketPort: Int, secure: Boolean) {
        ...
        scope.launch {
            session = try {
                client.webSocketSession {
                    ...
                    url(scheme, socketHost, socketPort, path)
                }
            } catch (e: Exception) {
